...
with col_title:
    ...
    <div style="margin-top: 0.5rem;">
        <h1 style="color: #1f77b4; margin-bottom: 0.5rem;">📍 k-Nearest Neighbors (k-NN)</h1>
    </div>
...
# =========================
st.markdown("""
<div style="background: linear-gradient(135deg, #8c564b 0%, #c49c94 100%); 
            padding: 1.5rem; border-radius: 12px; color: white; margin-bottom: 2rem;">
    <p style="font-size: 1.05rem; line-height: 1.8; margin: 0;">
        Le modèle k-NN est un algorithme de classification basé sur la distance.
        <br>Il classe une tumeur en fonction des k observations les plus proches dans l'espace des caractéristiques.
    </p>
</div>
""", unsafe_allow_html=True)
